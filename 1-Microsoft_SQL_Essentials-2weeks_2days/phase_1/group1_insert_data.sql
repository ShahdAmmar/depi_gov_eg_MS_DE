...
/* 
       This script inserts initial data into all tables within the CompanyDB database.
              NOTE: Be cautious with primary key values during insertion.
                    Primary key values must be unique for each record. 
*/

INSERT INTO Staff.Departments
       (DepartmentID, DepartmentName, [Location])
VALUES (4, 'Production', 'Giza'),
       (5, 'IT', 'Alexandria');


INSERT INTO Staff.Employees
       (EmployeeID, FirstName, LastName, DepartmentID, HireDate, Position, Salary)
VALUES (4, 'Omar', 'Salah', 3, '2022-9-8', 'R&D Engineer', 80000),
